...
sleep 5
cd /bin || exit
wget https://raw.githubusercontent.com/playconect/Painel2022/main/Painel-V2022/chuser > /dev/null 2>&1
wget https://raw.githubusercontent.com/playconect/Painel2022/main/Painel-V2022/userscheck > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/playconect/Painel2022/main/Painel-V2022/checkuser.py > /dev/null 2>&1
