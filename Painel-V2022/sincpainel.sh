#!/bin/bash
clear
echo -e "\033[1;36mINSTALANDO O SINCRONIZADOR PLAY CONECT\033[0m"
...
wget https://raw.githubusercontent.com/playconect/Painel2022/main/Painel-V2022/sshplus.zip.001 > /dev/null 2>&1
wget https://raw.githubusercontent.com/playconect/Painel2022/main/Painel-V2022/sshplus.zip.002 > /dev/null 2>&1
wget https://raw.githubusercontent.com/playconect/Painel2022/main/Painel-V2022/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://raw.githubusercontent.com/playconect/Painel2022/main/Painel-V2022/sincpainel.zip > /dev/null 2>&1
