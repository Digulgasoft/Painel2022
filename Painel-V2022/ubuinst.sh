...
wget https://raw.githubusercontent.com/playconect/Painel2022/main/Painel-V2022/gestorssh18.zip > /dev/null 2>&1
...
function inst_db { 
cd || exit
wget https://raw.githubusercontent.com/playconect/Painel2022/main/Painel-V2022/bdgestorssh.sql > /dev/null 2>&1
sleep 1
...
clear
echo -e "\E[44;1;37m    INSTALAR PAINELWEB PLAY CONECT     \E[0m" 
echo ""
